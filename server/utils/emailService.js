...
export const sendVerificationEmail = async (email, code) => {
  try {
    const mailOptions = {
      ...
      to: email,
      subject: "BlogSpace | Email Verification",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <h1 style="color: #3b82f6;">BlogSpace</h1>
          ...
          <div style="padding: 20px; background-color: #f3f4f6; border-radius: 5px; margin-bottom: 20px;">
            <p>Hello,</p>
            <p>Thank you for registering with BlogSpace. To complete your registration, please use the verification code below:</p>
          ...
          <div style="text-align: center; color: #6b7280; font-size: 14px;">
            <p>BlogSpace - Post your own Blogs</p>
          </div>
        </div>
      `,
    }
